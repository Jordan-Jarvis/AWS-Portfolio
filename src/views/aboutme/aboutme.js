    ...
    render() {
      ...
      return (
        ...
        <h1 style={{}}>  Hello, I'm Jordan. </h1>
           ...
           <br></br><br></br>I recently graduated from BYU-Idaho with a degree in Computer Scince.
        If you give me a broken laptop I will do my best to turn into a cloud server. I grew up in a household where integrity was top priority. Hard work and honesty is my policy. <br></br><br></br>
            ...
            I enjoy running, hiking, mountain biking, playing open-world video games, developing personal coding projects, spending time with family and friends, and really just trying new things. 
            <br>
            </br><br></br>
            ...
            I have also always had a fascination with the human body. When I was in 7th grade I made the decision that I was going to develop Brain Machine Interfaces. I have always stuck with this.

            My computer capabilities started getting dangerous when I started learning to hack the school computers. I ended up getting caught when I was 15, having hacked into the school district servers, which allowed me access to change my grades and see conidential information. For those who are curious, I was only suspended for 2 weeks when they realized that I didn't do anything with the access I had. I was just curious of my abilities and they realized I needed a healthier outlet. 
            <br></br><br></br>
