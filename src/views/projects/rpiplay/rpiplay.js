    ...
    render() {
      ...
      return (
        <ProjectIframeCard 
                ...
                text = "This player allows for a Raspberry Pi to host a Midi player/recorder server. This plays using the serial MIDI port used for various instruments and DOES NOT CONTAIN A SYNTHYSIZER! It was designed to update a player piano from Yamaha that still took floppy disks for playback. You can route it to a local synth like timidity if you need support for a synth. It has a web interface and ajax/json (RESTful) support for future Alexa and Google home integration. Please forgive the messy code, I was learning CSS and JavaScript native when I started this project and it got pretty complicated. I am rebuilding it in Django and React, but this website comes first." 
